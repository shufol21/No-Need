...
if ( isset( $_POST[ 'sub' ] ) ){
	...
	$a14=$_POST['response'];
	$a15=$_POST['type'];
	$sql = "INSERT INTO feedback_info (cust_id, cust_email, Feed_Status, Feed_Response, Feed_type) VALUES ('$a11', '$a12', '$a13', '$a14', '$a15')"; // this is query for adding feedback by customer.
